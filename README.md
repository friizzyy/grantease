...
![GrantEase](https://img.shields.io/badge/version-0.1.0-pulse)
...
```bash
git clone https://github.com/yourusername/grantease.git
cd grantease
```
...
# DATABASE_URL="postgresql://user:password@localhost:5432/grantease"  # PostgreSQL for production
