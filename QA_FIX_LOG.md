# GrantEase QA Fix Log

## Overview
This document summarizes all fixes made during the comprehensive QA sweep of the GrantEase application.
...
**Issue:** Clicking "GrantEase" logo in the sidebar while in `/app` took users to `/` (marketing page)
