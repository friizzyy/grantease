    ...
    extend: {
      colors: {
        ...
        pulse: {
          ...
          rose: '#40ffaa',
          'rose-dim': 'rgba(64, 255, 170, 0.15)',
          indigo: '#2dd4bf',
          'indigo-dim': 'rgba(45, 212, 191, 0.15)',
          text: '#fafafa',
      ...
      boxShadow: {
        ...
        'rose': '0 0 40px rgba(64, 255, 170, 0.1)',
        'rose-lg': '0 0 60px rgba(64, 255, 170, 0.15)',
        'indigo': '0 0 40px rgba(45, 212, 191, 0.1)',
