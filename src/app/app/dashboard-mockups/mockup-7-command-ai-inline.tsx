...
/**
 * MOCKUP 7: COMMAND CENTER + INLINE AI CARDS
 * -------------------------------------------
 * Command Center bento layout with AI recommendations woven into the grid
 * - AI insight cards scattered throughout the bento grid
 * - Expandable AI command bar at top
 * - Smart recommendations as bento tiles
 */
...
const upcomingDeadlines = [
  { title: 'SBIR Phase I', days: 3, amount: '$275K', urgent: true, progress: 75 },
  { title: 'Community Block Grant', days: 12, amount: '$500K', urgent: false, progress: 30 },
  { title: 'EPA Environmental', days: 28, amount: '$150K', urgent: false, progress: 0 },
]
...
export default function MockupCommandAIInline() {
