  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] p-8">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-heading text-pulse-text mb-2">Grant not available</h2>
        <p className="text-body-sm text-pulse-text-secondary mb-6">
          We couldn&apos;t load this grant&apos;s details. It may have been removed or there&apos;s a temporary issue.
        </p>
        {error.digest && (
