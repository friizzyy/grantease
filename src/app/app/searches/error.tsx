...
export default function SearchesError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] p-8">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-heading text-pulse-text mb-2">Saved searches unavailable</h2>
        <p className="text-body-sm text-pulse-text-secondary mb-6">
          Couldn&apos;t load your saved searches. They&apos;re still safe.
        </p>
        {error.digest && (
