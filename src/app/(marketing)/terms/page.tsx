      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-lg text-pulse-text-secondary leading-relaxed mb-4">
            These terms govern your use of GrantEase. By accessing our platform, you agree to be bound by
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-pulse-text-secondary">
              GrantEase offers a comprehensive platform for discovering and managing grant opportunities.
            </p>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                description: 'Using GrantEase does not guarantee you will receive grant funding. Success depends on many factors including eligibility, application quality, and funder decisions.',
              },
              {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-pulse-text-secondary leading-relaxed">
                The GrantEase platform, including its design, features, code, and content, is protected
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="mailto:legal@grantease.com"
