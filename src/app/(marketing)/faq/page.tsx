...
const faqs = [
  {
    ...
    questions: [
      {
        q: 'What is GrantEase?',
        a: 'GrantEase is an intelligent grant discovery platform that aggregates funding opportunities from federal, state, local, nonprofit, and private sources.',
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: 'Does GrantEase submit applications?',
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg text-pulse-text-secondary max-w-xl mx-auto">
            Everything you need to know about GrantEase.{' '}
