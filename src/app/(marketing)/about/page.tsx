...
const timeline = [
  ...
  { year: '2023', title: 'The Solution', description: 'Built GrantEase, aggregating 20+ sources into one platform.' },
  { year: '2024', title: 'The Growth', description: 'Expanded to 50+ sources, launched AI matching, 10K users.' },
  { year: 'Now', title: 'The Mission', description: '15,000+ organizations trust GrantEase for funding.' },
]
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.03] border border-white/[0.08] mb-6">
                ...
                <span className="text-sm text-pulse-text-secondary">About GrantEase</span>
              </div>
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg text-pulse-text-secondary mb-8">
            Start discovering grants today and see why 15,000+ organizations trust GrantEase.
          </p>
