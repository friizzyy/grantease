...
const mainFeatures = [
  ...
  },
  {
    icon: Bell,
    title: 'Smart Alerts',
    description: 'Save searches and get instant notifications when new grants match your criteria. Never miss a deadline or opportunity again.',
  },
]
  ...
  return (
    <Section className="bg-gradient-to-b from-transparent via-pulse-surface/20 to-transparent">
      <SectionHeader
        ...
        description="GrantEase combines comprehensive data with intelligent analysis to help you find and win funding."
      />
      ...
      <BentoGrid className="mb-12">
        ...
        <BentoCard
          ...
          description="Create custom alerts for specific categories, agencies, or funding ranges. Get notified the moment a matching grant is published—giving you maximum time to prepare your application."
          size="wide"
        >
