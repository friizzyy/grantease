    ...
    <section className="relative py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-pulse-text mb-6 tracking-tight">
            Ready to find your funding?
          </h2>

          <p className="text-lg md:text-xl text-pulse-text-secondary mb-10 max-w-2xl mx-auto leading-relaxed">
