      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <div className="font-serif text-4xl lg:text-5xl text-pulse-accent mb-3 tracking-tight">
                {stat.value}
              </div>
              <div className="text-sm lg:text-base text-pulse-text-secondary font-medium">
                {stat.label}
              </div>
            </div>
          ))}
