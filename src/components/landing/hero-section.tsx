      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-pulse-accent/10 border border-pulse-accent/20 mb-8">
              ...
              <span className="text-sm text-pulse-accent font-medium tracking-wide">
                AI-Powered Grant Discovery
              </span>
            </div>

            {/* Main headline - Large and intentional */}
            <h1 className="font-serif text-5xl sm:text-6xl lg:text-7xl text-pulse-text leading-[1.1] mb-6 tracking-tight">
              Find grants across{' '}
            ...
            {/* Subheadline */}
            <p className="text-xl text-pulse-text-secondary leading-relaxed mb-10 max-w-xl">
            ...
            {/* Trust indicators */}
            <div className="flex flex-wrap gap-x-8 gap-y-3 text-sm text-pulse-text-secondary">
            ...
            <div className="relative">
              ...
              <div className="relative bg-pulse-elevated/80 backdrop-blur-xl border border-pulse-border/50 rounded-3xl p-8 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.6)]">
                ...
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <div className="text-sm text-pulse-text-secondary mb-1">Matching Grants</div>
                    <div className="text-3xl font-serif text-pulse-text">2,847</div>
                  </div>
                  <div className="px-3 py-1 rounded-full bg-pulse-success/10 border border-pulse-success/20 text-pulse-success text-sm font-medium">
                    +127 today
                  </div>
                </div>
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          <div className="font-medium text-pulse-text mb-1">{grant.title}</div>
                          <div className="text-sm text-pulse-text-secondary">{grant.amount}</div>
                        </div>
                        <div className="text-xs text-pulse-accent whitespace-nowrap">{grant.deadline}</div>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="absolute -top-6 -right-6 w-24 h-24 rounded-2xl bg-pulse-accent/10 border border-pulse-accent/20 flex items-center justify-center backdrop-blur-sm">
                <div className="text-center">
                  <div className="text-2xl font-serif text-pulse-accent">98%</div>
                  <div className="text-xs text-pulse-accent/70">Match rate</div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-4 -left-4 px-4 py-3 rounded-xl bg-pulse-surface/90 border border-pulse-border/50 backdrop-blur-sm shadow-lg">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-pulse-text">Live data sync active</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-20 pt-12 border-t border-pulse-border/30">
          <div className="flex items-center gap-4 mb-6">
            <span className="text-sm font-medium text-pulse-text-secondary">Popular categories:</span>
          </div>
