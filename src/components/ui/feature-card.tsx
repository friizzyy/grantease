  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <h3 className="text-xl font-semibold text-pulse-text mb-3 transition-colors duration-300 group-hover:text-pulse-accent">
          {title}
        </h3>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        {/* Title */}
        <h3 className="text-2xl font-semibold text-pulse-text mb-3">
          {title}
        </h3>

        {/* Description */}
        <p className="text-pulse-text-secondary leading-relaxed mb-6">
          {description}
        </p>
...
export function StatCard({ value, label, sublabel, trend, className }: StatCardProps) {
  return (
    ...
    >
      ...
      {/* Label */}
      <div className="text-sm font-medium text-pulse-text-secondary mb-1">
        {label}
      </div>
      ...
      {trend && (
        <div
          className={cn(
            'absolute top-6 right-6 inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium',
            trend.isPositive
