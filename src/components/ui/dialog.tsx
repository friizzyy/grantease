...
import { springs, modalOverlayVariants, modalContentVariants } from '@/lib/motion/animations'
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      ...
      <div className="absolute inset-x-0 -top-px h-px bg-gradient-to-r from-transparent via-pulse-accent/30 to-transparent" />
      ...
      {/* Glow effect on bottom edge */}
      <div className="absolute inset-x-0 -bottom-px h-px bg-gradient-to-r from-transparent via-pulse-accent/10 to-transparent" />
    </DialogPrimitive.Content>
  </DialogPortal>
))
