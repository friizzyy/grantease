  ...
  return (
    <Card className="p-6 group">
      ...
      <div className="flex items-start justify-between gap-4 mb-3">
        <motion.span
          className="font-mono text-micro uppercase tracking-wider text-pulse-accent"
      ...
      <Link href={`/app/grants/${grant.id}`} className="block group/link">
        <motion.h3
          className="text-lg font-medium text-pulse-text group-hover/link:text-pulse-accent transition-colors mb-2 line-clamp-2"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      {/* Summary */}
      <motion.p
        className="text-sm text-pulse-text-secondary mb-4 line-clamp-3"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
