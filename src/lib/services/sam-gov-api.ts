...
export function normalizeSamGovOpportunity(opp: SamGovOpportunity) {
  ...
  return {
    ...
    title: opp.title,
    sponsor,
    summary: opp.description?.substring(0, 500) || `${PROCUREMENT_TYPES[opp.type as keyof typeof PROCUREMENT_TYPES] || opp.type} - ${opp.solicitationNumber || 'No solicitation number'}`,
